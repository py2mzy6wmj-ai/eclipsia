...
export var ENM = [
  { id: "e_loup", name: "Loup", icon: "🐺", hp: 40, dmg: 10, at: "physical", str: 1.0, mag: 1.0, crit: 0.08, phv: 0.97, dodge: 0.08, mav: 1.02, xp: 5, gold: 4, er: defER() },
  { id: "e_vautour", name: "Vautour", icon: "🦅", hp: 28, dmg: 8, at: "physical", str: 1.0, mag: 1.0, crit: 0.12, phv: 1.02, dodge: 0.14, mav: 1.04, xp: 4, gold: 3, er: { Feu: 1.1, Terre: 1, Foudre: 1.1, Eau: 1, Sacré: 1, Ténèbres: 1 } },
  { id: "e_sanglier", name: "Sanglier", icon: "🐗", hp: 55, dmg: 13, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.93, dodge: 0.03, mav: 1.05, xp: 6, gold: 5, er: defER() },
  { id: "e_chasseur", name: "Chasseur", icon: "🏹", hp: 35, dmg: 12, at: "physical", str: 1.0, mag: 1.0, crit: 0.10, phv: 0.98, dodge: 0.06, mav: 1.0, xp: 5, gold: 6, er: defER() },
  { id: "e_slime_bleu", name: "Slime bleu", icon: "🫧", hp: 50, dmg: 7, at: "magical", str: 1.0, mag: 1.0, crit: 0.02, phv: 0.94, dodge: 0.02, mav: 0.94, xp: 4, gold: 3, er: { Feu: 1.15, Terre: 1, Foudre: 1.1, Eau: 0.50, Sacré: 1, Ténèbres: 1 } },
  { id: "e_crabe", name: "Crabe géant", icon: "🦀", hp: 60, dmg: 14, at: "physical", str: 1.0, mag: 1.0, crit: 0.03, phv: 0.88, dodge: 0.01, mav: 1.05, xp: 6, gold: 5, er: { Feu: 1, Terre: 0.9, Foudre: 1.1, Eau: 0.85, Sacré: 1, Ténèbres: 1 } },
  { id: "e_saurien", name: "Guerrier saurien", icon: "🦎", hp: 48, dmg: 13, at: "physical", str: 1.0, mag: 1.0, crit: 0.06, phv: 0.94, dodge: 0.05, mav: 0.98, xp: 6, gold: 6, er: { Feu: 0.9, Terre: 0.9, Foudre: 1, Eau: 1.1, Sacré: 1, Ténèbres: 1 } },
  { id: "e_scorpion", name: "Scorpion", icon: "🦂", hp: 38, dmg: 15, at: "physical", str: 1.0, mag: 1.0, crit: 0.10, phv: 0.96, dodge: 0.06, mav: 1.04, xp: 5, gold: 5, er: { Feu: 1.1, Terre: 0.85, Foudre: 1, Eau: 1.1, Sacré: 1, Ténèbres: 1 } },
  { id: "e_cactuaire", name: "Cactuaire", icon: "🌵", hp: 30, dmg: 9, at: "physical", str: 1.0, mag: 1.0, crit: 0.15, phv: 0.98, dodge: 0.12, mav: 1.0, xp: 4, gold: 4, er: { Feu: 1.2, Terre: 0.8, Foudre: 1, Eau: 0.7, Sacré: 1, Ténèbres: 1 } },
  { id: "e_slime_jaune", name: "Slime jaune", icon: "💛", hp: 52, dmg: 8, at: "magical", str: 1.0, mag: 1.0, crit: 0.02, phv: 0.95, dodge: 0.02, mav: 0.92, xp: 4, gold: 3, er: { Feu: 1.1, Terre: 1, Foudre: 0.50, Eau: 1.1, Sacré: 1, Ténèbres: 1 } },
  { id: "e_mage_noir", name: "Mage noir", icon: "🧙", hp: 32, dmg: 15, at: "magical", str: 1.0, mag: 1.0, crit: 0.06, phv: 1.04, dodge: 0.04, mav: 0.93, xp: 7, gold: 7, er: { Feu: 1, Terre: 1, Foudre: 1, Eau: 1, Sacré: 1.2, Ténèbres: 0.8 } },
  { id: "e_esprit", name: "Esprit farouche", icon: "👻", hp: 30, dmg: 12, at: "magical", str: 1.0, mag: 1.0, crit: 0.04, phv: 1.08, dodge: 0.15, mav: 0.95, xp: 5, gold: 5, er: { Feu: 1, Terre: 1, Foudre: 1, Eau: 1, Sacré: 1.25, Ténèbres: 0.70 } },
  { id: "e_coupe_jarret", name: "Coupe-jarret", icon: "🗡️", hp: 36, dmg: 14, at: "physical", str: 1.0, mag: 1.0, crit: 0.12, phv: 0.99, dodge: 0.10, mav: 1.02, xp: 5, gold: 8, er: defER() },
  { id: "e_soldat_corrompu", name: "Soldat corrompu", icon: "⚔️", hp: 52, dmg: 12, at: "physical", str: 1.0, mag: 1.0, crit: 0.05, phv: 0.92, dodge: 0.03, mav: 0.98, xp: 6, gold: 6, er: defER() },
  { id: "e_homme_serpent", name: "Homme-serpent", icon: "🐍", hp: 42, dmg: 13, at: "physical", str: 1.0, mag: 1.0, crit: 0.08, phv: 0.96, dodge: 0.08, mav: 0.96, xp: 6, gold: 6, er: { Feu: 1, Terre: 0.9, Foudre: 1, Eau: 1, Sacré: 1.1, Ténèbres: 0.9 } },
  { id: "e_garde_royal", name: "Garde royal", icon: "🛡️", hp: 58, dmg: 11, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.88, dodge: 0.02, mav: 0.96, xp: 6, gold: 5, er: defER() },
  { id: "e_statue_animee", name: "Statue animée", icon: "🗿", hp: 70, dmg: 14, at: "physical", str: 1.0, mag: 1.0, crit: 0.02, phv: 0.84, dodge: 0, mav: 1.06, xp: 7, gold: 5, er: { Feu: 0.9, Terre: 0.7, Foudre: 0.9, Eau: 1, Sacré: 1.1, Ténèbres: 1 } },
  { id: "e_assassin", name: "Assassin", icon: "🥷", hp: 30, dmg: 16, at: "physical", str: 1.0, mag: 1.0, crit: 0.15, phv: 1.02, dodge: 0.14, mav: 1.02, xp: 6, gold: 8, er: defER() },
  { id: "e_squelette", name: "Squelette", icon: "💀", hp: 38, dmg: 10, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.96, dodge: 0.02, mav: 1.0, xp: 4, gold: 3, er: { Feu: 1.15, Terre: 1, Foudre: 1, Eau: 1, Sacré: 1.2, Ténèbres: 0.8 } },
  { id: "e_zombie", name: "Zombie", icon: "🧟", hp: 65, dmg: 9, at: "physical", str: 1.0, mag: 1.0, crit: 0.01, phv: 0.92, dodge: 0, mav: 1.04, xp: 5, gold: 3, er: { Feu: 1.2, Terre: 1, Foudre: 1, Eau: 1, Sacré: 1.2, Ténèbres: 0.7 } },
  { id: "e_slime_noir", name: "Slime noir", icon: "🖤", hp: 55, dmg: 8, at: "magical", str: 1.0, mag: 1.0, crit: 0.02, phv: 0.94, dodge: 0.02, mav: 0.92, xp: 4, gold: 3, er: { Feu: 1.1, Terre: 1, Foudre: 1, Eau: 1, Sacré: 1.2, Ténèbres: 0.40 } },
  { id: "e_slime_rouge", name: "Slime rouge", icon: "❤️‍🔥", hp: 50, dmg: 9, at: "magical", str: 1.0, mag: 1.0, crit: 0.03, phv: 0.94, dodge: 0.02, mav: 0.92, xp: 5, gold: 4, er: { Feu: 0, Terre: 1, Foudre: 1, Eau: 1.3, Sacré: 1, Ténèbres: 1 } },
  { id: "e_demon_inf", name: "Démon inférieur", icon: "😈", hp: 45, dmg: 14, at: "physical", str: 1.0, mag: 1.0, crit: 0.08, phv: 0.95, dodge: 0.05, mav: 0.95, xp: 6, gold: 6, er: { Feu: 0.7, Terre: 1, Foudre: 1, Eau: 1.15, Sacré: 1.2, Ténèbres: 0.8 } },
  { id: "e_armure", name: "Armure possédée", icon: "🛡️", hp: 68, dmg: 13, at: "physical", str: 1.0, mag: 1.0, crit: 0.03, phv: 0.85, dodge: 0, mav: 1.0, xp: 6, gold: 5, er: { Feu: 1, Terre: 0.9, Foudre: 1, Eau: 1, Sacré: 1.15, Ténèbres: 0.85 } },
  { id: "e_diablotin", name: "Diablotin", icon: "👿", hp: 25, dmg: 11, at: "magical", str: 1.0, mag: 1.0, crit: 0.10, phv: 1.04, dodge: 0.12, mav: 0.98, xp: 4, gold: 5, er: { Feu: 0.6, Terre: 1, Foudre: 1, Eau: 1.2, Sacré: 1.15, Ténèbres: 0.7 } },
  { id: "e_demon_sup", name: "Démon supérieur", icon: "👹", hp: 55, dmg: 16, at: "physical", str: 1.0, mag: 1.0, crit: 0.08, phv: 0.92, dodge: 0.05, mav: 0.92, xp: 8, gold: 8, er: { Feu: 0.5, Terre: 1, Foudre: 1, Eau: 1.2, Sacré: 1.25, Ténèbres: 0.7 } },
  { id: "e_chien_infernal", name: "Chien infernal", icon: "🐕‍🦺", hp: 40, dmg: 15, at: "physical", str: 1.0, mag: 1.0, crit: 0.10, phv: 0.96, dodge: 0.08, mav: 1.02, xp: 6, gold: 6, er: { Feu: 0, Terre: 1, Foudre: 1, Eau: 1.3, Sacré: 1.1, Ténèbres: 0.8 } },
  { id: "e_mage_noir2", name: "Mage noir", icon: "🧙‍♂️", hp: 32, dmg: 16, at: "magical", str: 1.0, mag: 1.0, crit: 0.06, phv: 1.04, dodge: 0.04, mav: 0.90, xp: 7, gold: 7, er: { Feu: 1, Terre: 1, Foudre: 1, Eau: 1, Sacré: 1.2, Ténèbres: 0.7 } },
  { id: "e_slime_chroma", name: "Slime chromatique", icon: "🌈", hp: 60, dmg: 11, at: "magical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.92, dodge: 0.03, mav: 0.90, xp: 6, gold: 5, er: { Feu: 0.85, Terre: 0.85, Foudre: 0.85, Eau: 0.85, Sacré: 0.85, Ténèbres: 0.85 } },
];
...
export var DG = [
  ...
  { name:"Catacombes Royales",m:10,rw:1,diff:0,ul:6,structure:[{type:"combat",count:[1,1]},{type:"combat",count:[1,1]},{type:"combat",count:[1,1]},{type:"combat",count:[1,1]},{type:"combat",count:[1,1]},{type:"combat",count:[1,2]},{type:"combat",count:[1,2]},{type:"combat",count:[1,2]},{type:"combat",count:[1,2]},{type:"combat",count:[1,2]},{type:"combat",count:[2,3]},{type:"combat",count:[2,3]},{type:"combat",count:[2,3]},{type:"combat",count:[2,3]},{type:"combat",count:[2,3]},{type:"combat",count:[3,3]},{type:"combat",count:[3,3]},{type:"combat",count:[3,3]},{type:"combat",count:[3,3]},{type:"boss"}],enemies:["e_squelette","e_zombie","e_slime_noir"],bosses:["b_necromancien"],loot:{ranks:[2,3],rarW:{1:0.5,2:0.4,3:0.1},dropRate:0.20,nbLoot:3},reward:{gold:1000,xp:280},firstBonus:{gold:1000,xp:840,scrolls:4,equip:4},desc:"Les morts ne reposent pas en paix." },
  ...
  { name:"Forteresse du Seigneur des Enfers",m:15,rw:1,diff:0,ul:8,structure:[{type:"combat",count:[1,1]},{type:"combat",count:[1,1]},{type:"combat",count:[1,1]},{type:"combat",count:[1,1]},{type:"combat",count:[1,1]},{type:"event"},{type:"combat",count:[2,2]},{type:"combat",count:[2,2]},{type:"combat",count:[2,2]},{type:"combat",count:[2,2]},{type:"combat",count:[2,2]},{type:"event"},{type:"combat",count:[2,3]},{type:"combat",count:[2,3]},{type:"combat",count:[2,3]},{type:"combat",count:[2,3]},{type:"combat",count:[2,3]},{type:"event"},{type:"combat",count:[3,3]},{type:"combat",count:[3,3]},{type:"combat",count:[3,3]},{type:"combat",count:[3,3]},{type:"combat",count:[3,3]},{type:"combat",count:[3,3]},{type:"event"},{type:"combat",count:[3,4]},{type:"combat",count:[3,4]},{type:"combat",count:[3,4]},{type:"combat",count:[3,4]},{type:"boss"}],enemies:["e_demon_sup","e_chien_infernal","e_mage_noir2","e_slime_chroma"],bosses:["b_myhrra"],loot:{ranks:[3,3],rarW:{1:0.45,2:0.40,3:0.15},dropRate:0.20,nbLoot:4},reward:{gold:1500,xp:420},firstBonus:{gold:3000,xp:1500,scrolls:10,equip:5,tomes:{tome_2:10}},desc:"Myhrra attend au sommet." },
];
