...
export var SKILLS = {
  ...
  zevor:     { name: "Enchantement explosif", type: "mAtk", mult: 2.5, cd: 7, desc: "Attaque magique ×2.5", lvl: 1 },

  riane:     { name: "Jugement Sacré",     type: "pAtk", mult: 3.0, cd: 8, desc: "Frappe sacrée dévastatrice ×3.0", lvl: 1 },};
...
export var HEROES = [
  { id: "enzi", name: "Enzi", title: "Aventurier solitaire", rarity: 1, icon: "🗡️", color: "#7f8c8d", wt: "physical",
    ...
    lv1: { hp: 31, rel: 7, str: 1.0, mag: 0.10, crit: 0.03, phv: 1.0, mav: 1.04, dodge: 0.05 },
    lv100: { hp: 2000, rel: 7, str: 1.19, mag: 0.10, crit: 0.06, phv: 0.91, mav: 0.97, dodge: 0.05 },
    er: { Feu: 1.25, Terre: 0.75, Foudre: 1.10, Eau: 0.90, Sacré: 1.10, Ténèbres: 0.90 } },
  { id: "kiara", name: "Kiara", title: "Nomade du désert", rarity: 1, icon: "⚔️", color: "#d4a017", wt: "physical",
    ...
    lv1: { hp: 35, rel: 8, str: 1.01, mag: 0.10, crit: 0.03, phv: 0.99, mav: 1.01, dodge: 0.04 },
    lv100: { hp: 2100, rel: 8, str: 1.22, mag: 0.10, crit: 0.05, phv: 0.90, mav: 0.95, dodge: 0.04 },
    er: { Feu: 0.75, Terre: 0.90, Foudre: 1.0, Eau: 1.25, Sacré: 1.0, Ténèbres: 1.0 } },
  { id: "marken", name: "Marken", title: "Preux chevalier", rarity: 1, icon: "🛡️", color: "#2c3e50", wt: "physical",
    ...
    lv1: { hp: 37, rel: 8, str: 1.02, mag: 0.10, crit: 0.02, phv: 0.98, mav: 1.08, dodge: 0.03 },
    lv100: { hp: 2250, rel: 8, str: 1.25, mag: 0.10, crit: 0.04, phv: 0.87, mav: 1.02, dodge: 0.03 },
    er: { Feu: 1.05, Terre: 1.0, Foudre: 1.05, Eau: 1.0, Sacré: 0.90, Ténèbres: 0.90 } },
  { id: "mira", name: "Mira", title: "Apprentie sorcière", rarity: 1, icon: "🔮", color: "#e67e22", wt: "magical",
    ...
    lv1: { hp: 25, rel: 7, str: 0.10, mag: 1.03, crit: 0.03, phv: 1.10, mav: 0.99, dodge: 0.04 },
    lv100: { hp: 1600, rel: 7, str: 0.10, mag: 1.28, crit: 0.05, phv: 1.02, mav: 0.92, dodge: 0.04 },
    er: { Feu: 0.98, Terre: 0.98, Foudre: 0.98, Eau: 0.98, Sacré: 1.0, Ténèbres: 1.08 } },
  { id: "constello", name: "Constello", title: "Saltimbanque survolté", rarity: 2, icon: "🎭", color: "#e84393", wt: "physical",
    ...
    lv1: { hp: 32, rel: 7, str: 1.06, mag: 0.10, crit: 0.04, phv: 0.96, mav: 1.10, dodge: 0.05 },
    lv100: { hp: 2000, rel: 7, str: 1.30, mag: 0.10, crit: 0.07, phv: 0.85, mav: 1.04, dodge: 0.05 },
    er: { Feu: 1.10, Terre: 1.10, Foudre: 1.10, Eau: 1.10, Sacré: 1.10, Ténèbres: 1.10 } },
  { id: "sahad", name: "Sahad", title: "Aquamage", rarity: 2, icon: "💧", color: "#3498db", wt: "magical",
    ...
    lv1: { hp: 29, rel: 8, str: 0.10, mag: 1.02, crit: 0.03, phv: 1.04, mav: 0.97, dodge: 0.04 },
    lv100: { hp: 1850, rel: 8, str: 0.10, mag: 1.25, crit: 0.05, phv: 0.97, mav: 0.89, dodge: 0.04 },
    er: { Feu: 0.75, Terre: 1.0, Foudre: 1.25, Eau: 0.75, Sacré: 1.0, Ténèbres: 1.0 } },
  { id: "syrio", name: "Syrio", title: "Défenseur inébranlable", rarity: 2, icon: "🏰", color: "#c0392b", wt: "physical",
    ...
    lv1: { hp: 46, rel: 8, str: 1.0, mag: 0.10, crit: 0.02, phv: 0.91, mav: 0.99, dodge: 0.02 },
    lv100: { hp: 2900, rel: 8, str: 1.12, mag: 0.10, crit: 0.04, phv: 0.82, mav: 0.91, dodge: 0.02 },
    er: { Feu: 0.95, Terre: 0.95, Foudre: 0.95, Eau: 0.95, Sacré: 0.95, Ténèbres: 1.0 } },
  { id: "zevor", name: "Zevor", title: "Mage de guerre", rarity: 2, icon: "🔥", color: "#8e44ad", wt: "magical",
    lore: "Spécialiste de l'enchantement d'arme et d'ustensile de cuisine.",
    lv1: { hp: 32, rel: 7, str: 0.10, mag: 1.01, crit: 0.03, phv: 1.01, mav: 0.99, dodge: 0.04 },
    lv100: { hp: 2100, rel: 7, str: 0.10, mag: 1.19, crit: 0.05, phv: 0.94, mav: 0.91, dodge: 0.04 },
    er: { Feu: 0.91, Terre: 0.92, Foudre: 0.91, Eau: 0.91, Sacré: 1.05, Ténèbres: 1.05 } },
  { id: "cerys", name: "Cerys", title: "Sombre inquisitrice", rarity: 3, icon: "🌑", color: "#6c3483", wt: "magical",
    ...
    lv1: { hp: 25, rel: 7, str: 0.10, mag: 1.05, crit: 0.03, phv: 1.04, mav: 1.0, dodge: 0.04 },
    lv100: { hp: 1600, rel: 7, str: 0.10, mag: 1.35, crit: 0.05, phv: 0.97, mav: 0.92, dodge: 0.04 },
    er: { Feu: 0.95, Terre: 0.95, Foudre: 0.95, Eau: 0.95, Sacré: 1.20, Ténèbres: 0.50 } },
  { id: "keros", name: "Keros", title: "Saurien mystérieux", rarity: 3, icon: "🦎", color: "#27ae60", wt: "physical",
    ...
    lv1: { hp: 32, rel: 8, str: 1.01, mag: 0.10, crit: 0.03, phv: 0.99, mav: 0.99, dodge: 0.04, rgHp: 0.01 },
    lv100: { hp: 2100, rel: 8, str: 1.22, mag: 0.10, crit: 0.04, phv: 0.91, mav: 0.91, dodge: 0.04, rgHp: 0.03 },
    er: { Feu: 0.80, Terre: 0.80, Foudre: 1.0, Eau: 0.90, Sacré: 1.0, Ténèbres: 1.0 } },
  { id: "orion", name: "Orion", title: "Félin malicieux", rarity: 4, icon: "🐱", color: "#f39c12", wt: "magical",
    ...
    lv1: { hp: 24, rel: 7, str: 0.10, mag: 1.04, crit: 0.04, phv: 1.12, mav: 0.92, dodge: 0.06 },
    lv100: { hp: 1550, rel: 7, str: 0.10, mag: 1.30, crit: 0.05, phv: 1.04, mav: 0.83, dodge: 0.06 },
    er: { Feu: 0.80, Terre: 0.80, Foudre: 0.80, Eau: 1.25, Sacré: 0.80, Ténèbres: 0.80 } },
  { id: "riane", name: "Riane", title: "Chevalière de l'Aube", rarity: 5, icon: "⚜️", color: "#ff9a30", wt: "physical",
    lore: "Dernière héritière d'un ordre de chevaliers légendaires. Son armure dorée et sa lame bénie inspirent la bravoure.",
    lv1: { hp: 33, rel: 8, str: 1.02, mag: 0.10, crit: 0.04, phv: 0.97, mav: 0.98, dodge: 0.03 },
    lv100: { hp: 2100, rel: 8, str: 1.20, mag: 0.10, crit: 0.04, phv: 0.88, mav: 0.90, dodge: 0.03 },
    er: { Feu: 0.80, Terre: 0.80, Foudre: 0.80, Eau: 0.80, Sacré: 0.80, Ténèbres: 1.00 } },
];
...
export var ENM = [
  { id: "e_loup", name: "Loup", icon: "🐺", hp: 40, dmg: 10, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.97, dodge: 0.08, mav: 1.02, xp: 5, gold: 5, er: { Feu: 1.3, Terre: 1, Foudre: 1.0, Eau: 1.0, Sacré: 1, Ténèbres: 0.9 } },
  { id: "e_vautour", name: "Vautour", icon: "🦅", hp: 28, dmg: 8, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 1.02, dodge: 0.1, mav: 1.04, xp: 5, gold: 5, er: { Feu: 1, Terre: 0.5, Foudre: 1.5, Eau: 1.0, Sacré: 1, Ténèbres: 1 } },
  { id: "e_sanglier", name: "Sanglier", icon: "🐗", hp: 70, dmg: 12, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.85, dodge: 0.03, mav: 1, xp: 6, gold: 5, er: { Feu: 0.9, Terre: 0.9, Foudre: 0.9, Eau: 0.9, Sacré: 0.9, Ténèbres: 1 } },
  { id: "e_chasseur", name: "Chasseur", icon: "🏹", hp: 35, dmg: 14, at: "physical", str: 1.0, mag: 1.0, crit: 0.06, phv: 1.02, dodge: 0.07, mav: 1.04, xp: 5, gold: 6, er: { Feu: 1.1, Terre: 1.1, Foudre: 1.1, Eau: 1.0, Sacré: 1, Ténèbres: 1 } },
  { id: "e_slime_bleu", name: "Slime bleu", icon: "🔵", hp: 35, dmg: 15, at: "magical", str: 1.0, mag: 1.0, crit: 0.03, phv: 0.65, dodge: 0.02, mav: 1.35, xp: 6, gold: 5, er: { Feu: 0.7, Terre: 0.7, Foudre: 2.0, Eau: 0.2, Sacré: 0.7, Ténèbres: 0.7 } },
  { id: "e_crabe", name: "Crabe géant", icon: "🦀", hp: 55, dmg: 15, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.75, dodge: 0.05, mav: 1.1, xp: 6, gold: 5, er: { Feu: 1, Terre: 1, Foudre: 1.25, Eau: 0.75, Sacré: 1, Ténèbres: 1 } },
  { id: "e_saurien", name: "Guerrier saurien", icon: "🦎", hp: 40, dmg: 11, at: "physical", str: 1.0, mag: 1.0, crit: 0.05, phv: 1.05, dodge: 0.06, mav: 1, xp: 5, gold: 6, er: { Feu: 1.2, Terre: 1, Foudre: 1.0, Eau: 1.0, Sacré: 1, Ténèbres: 1 } },
  { id: "e_scorpion", name: "Scorpion", icon: "🦂", hp: 35, dmg: 13, at: "physical", str: 1.0, mag: 1.0, crit: 0.05, phv: 0.9, dodge: 0.05, mav: 0.9, xp: 6, gold: 5, er: { Feu: 0.85, Terre: 0.85, Foudre: 0.85, Eau: 0.9, Sacré: 1, Ténèbres: 1 } },
  { id: "e_cactuaire", name: "Cactuaire", icon: "🌵", hp: 33, dmg: 10, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 1, dodge: 0.04, mav: 1.15, xp: 4, gold: 5, er: { Feu: 1.3, Terre: 0.8, Foudre: 1.0, Eau: 0.8, Sacré: 1, Ténèbres: 1 } },
  { id: "e_slime_jaune", name: "Slime jaune", icon: "🟡", hp: 35, dmg: 15, at: "magical", str: 1.0, mag: 1.0, crit: 0.03, phv: 0.65, dodge: 0.02, mav: 1.35, xp: 6, gold: 5, er: { Feu: 0.7, Terre: 2, Foudre: 0.2, Eau: 0.7, Sacré: 0.7, Ténèbres: 0.7 } },
  { id: "e_mage_noir", name: "Mage noir", icon: "🧙", hp: 25, dmg: 18, at: "magical", str: 1.0, mag: 1.0, crit: 0.05, phv: 1.15, dodge: 0.04, mav: 0.9, xp: 5, gold: 6, er: { Feu: 1, Terre: 1, Foudre: 1.0, Eau: 1.0, Sacré: 1.3, Ténèbres: 0.7 } },
  { id: "e_esprit", name: "Esprit farouche", icon: "👻", hp: 35, dmg: 10, at: "magical", str: 1.0, mag: 1.0, crit: 0.03, phv: 0.7, dodge: 0.12, mav: 1.2, xp: 5, gold: 5, er: { Feu: 1, Terre: 1, Foudre: 1.0, Eau: 1.0, Sacré: 1.25, Ténèbres: 0.7 } },
  { id: "e_coupe_jarret", name: "Coupe-jarret", icon: "🗡️", hp: 42, dmg: 17, at: "physical", str: 1.0, mag: 1.0, crit: 0.06, phv: 1, dodge: 0.1, mav: 1, xp: 6, gold: 6, er: { Feu: 1.1, Terre: 1.1, Foudre: 1.1, Eau: 1.1, Sacré: 1, Ténèbres: 1 } },
  { id: "e_soldat_corrompu", name: "Soldat corrompu", icon: "⚔️", hp: 32, dmg: 15, at: "physical", str: 1.0, mag: 1.0, crit: 0.05, phv: 1, dodge: 0.06, mav: 1.04, xp: 5, gold: 6, er: { Feu: 1, Terre: 1, Foudre: 1.0, Eau: 1.0, Sacré: 1.1, Ténèbres: 1.1 } },
  { id: "e_homme_serpent", name: "Homme-serpent", icon: "🐍", hp: 25, dmg: 11, at: "physical", str: 1.0, mag: 1.0, crit: 0.05, phv: 1.15, dodge: 0.1, mav: 1.1, xp: 5, gold: 5, er: { Feu: 1.2, Terre: 0.9, Foudre: 0.9, Eau: 0.9, Sacré: 1, Ténèbres: 1 } },
  { id: "e_garde_royal", name: "Garde royal", icon: "🛡️", hp: 65, dmg: 11, at: "physical", str: 1.0, mag: 1.0, crit: 0.03, phv: 0.7, dodge: 0.03, mav: 0.9, xp: 6, gold: 5, er: { Feu: 0.8, Terre: 0.8, Foudre: 0.8, Eau: 0.8, Sacré: 0.8, Ténèbres: 0.8 } },
  { id: "e_statue_animee", name: "Statue animée", icon: "🗿", hp: 70, dmg: 13, at: "physical", str: 1.0, mag: 1.0, crit: 0.05, phv: 0.65, dodge: 0.02, mav: 1.2, xp: 7, gold: 5, er: { Feu: 0.7, Terre: 1.2, Foudre: 0.7, Eau: 0.7, Sacré: 0.8, Ténèbres: 0.8 } },
  { id: "e_assassin", name: "Assassin", icon: "🥷", hp: 35, dmg: 17, at: "physical", str: 1.0, mag: 1.0, crit: 0.07, phv: 1.05, dodge: 0.12, mav: 1.05, xp: 6, gold: 7, er: { Feu: 1, Terre: 1, Foudre: 1.0, Eau: 1.0, Sacré: 1, Ténèbres: 0.7 } },
  { id: "e_squelette", name: "Squelette", icon: "💀", hp: 28, dmg: 9, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 1.15, dodge: 0.03, mav: 0.95, xp: 4, gold: 5, er: { Feu: 1, Terre: 1, Foudre: 1.0, Eau: 1.0, Sacré: 1.35, Ténèbres: 0.9 } },
  { id: "e_zombie", name: "Zombie", icon: "🧟", hp: 40, dmg: 13, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.95, dodge: 0.02, mav: 1.1, xp: 5, gold: 5, er: { Feu: 1.3, Terre: 1, Foudre: 1.0, Eau: 1.0, Sacré: 1.35, Ténèbres: 0.9 } },
  { id: "e_slime_noir", name: "Slime noir", icon: "⚫️", hp: 35, dmg: 15, at: "magical", str: 1.0, mag: 1.0, crit: 0.03, phv: 0.65, dodge: 0.02, mav: 1.35, xp: 6, gold: 5, er: { Feu: 0.7, Terre: 0.7, Foudre: 0.7, Eau: 0.7, Sacré: 2, Ténèbres: 0.2 } },
  { id: "e_slime_rouge", name: "Slime rouge", icon: "🔴", hp: 35, dmg: 15, at: "magical", str: 1.0, mag: 1.0, crit: 0.03, phv: 0.65, dodge: 0.02, mav: 1.35, xp: 6, gold: 5, er: { Feu: 0.2, Terre: 0.7, Foudre: 0.7, Eau: 2.0, Sacré: 0.7, Ténèbres: 0.7 } },
  { id: "e_demon_inf", name: "Démon inférieur", icon: "😈", hp: 50, dmg: 13, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.95, dodge: 0.05, mav: 0.95, xp: 6, gold: 5, er: { Feu: 0.7, Terre: 1, Foudre: 1.0, Eau: 1.2, Sacré: 1.25, Ténèbres: 0.7 } },
  { id: "e_armure", name: "Armure possédée", icon: "🛡️", hp: 85, dmg: 10, at: "physical", str: 1.0, mag: 1.0, crit: 0.03, phv: 0.5, dodge: 0.01, mav: 0.85, xp: 7, gold: 5, er: { Feu: 0.7, Terre: 0.7, Foudre: 0.7, Eau: 0.7, Sacré: 0.7, Ténèbres: 0.7 } },
  { id: "e_diablotin", name: "Diablotin", icon: "👺", hp: 32, dmg: 16, at: "magical", str: 1.0, mag: 1.0, crit: 0.06, phv: 1.15, dodge: 0.11, mav: 1.2, xp: 6, gold: 6, er: { Feu: 0.8, Terre: 0.5, Foudre: 1.0, Eau: 1.0, Sacré: 1.3, Ténèbres: 0.8 } },
  { id: "e_demon_sup", name: "Démon supérieur", icon: "👿", hp: 70, dmg: 16, at: "physical", str: 1.0, mag: 1.0, crit: 0.05, phv: 0.9, dodge: 0.05, mav: 0.9, xp: 6, gold: 5, er: { Feu: 0.6, Terre: 0.9, Foudre: 0.9, Eau: 1.3, Sacré: 1.35, Ténèbres: 0.6 } },
...
// === LABYRINTHE MÉCANIQUE ===
  ...
  { id: "e_auto_antimagie", name: "Automate antimagie", icon: "🤖", hp: 55, dmg: 9, at: "physical", str: 1.0, mag: 1.0, crit: 0.03, phv: 1.05, dodge: 0.03, mav: 0.55, xp: 0, gold: 0, er: { Feu: 1.0, Terre: 1.0, Foudre: 1.0, Eau: 1.0, Sacré: 0.80, Ténèbres: 0.80 } },
  { id: "e_auto_sorcier", name: "Automate sorcier", icon: "🤖", hp: 25, dmg: 20, at: "magical", str: 1.0, mag: 1.0, crit: 0.06, phv: 1.20, dodge: 0.04, mav: 1.00, xp: 0, gold: 0, er: { Feu: 0.90, Terre: 1.0, Foudre: 0.90, Eau: 1.0, Sacré: 1.10, Ténèbres: 0.90 } },
  { id: "e_auto_ignifuge", name: "Automate ignifuge", icon: "🤖", hp: 45, dmg: 11, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.95, dodge: 0.05, mav: 1.00, xp: 0, gold: 0, er: { Feu: 0.0, Terre: 1.0, Foudre: 1.0, Eau: 1.30, Sacré: 1.0, Ténèbres: 1.0 } },
  { id: "e_auto_hydrophobe", name: "Automate hydrophobe", icon: "🤖", hp: 45, dmg: 11, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.95, dodge: 0.05, mav: 1.00, xp: 0, gold: 0, er: { Feu: 1.30, Terre: 1.0, Foudre: 1.0, Eau: 0.0, Sacré: 1.0, Ténèbres: 1.0 } },
  { id: "e_auto_paratonnerre", name: "Automate paratonnerre", icon: "🤖", hp: 45, dmg: 11, at: "magical", str: 1.0, mag: 1.0, crit: 0.04, phv: 1.00, dodge: 0.05, mav: 0.95, xp: 0, gold: 0, er: { Feu: 1.0, Terre: 1.30, Foudre: 0.0, Eau: 1.0, Sacré: 1.0, Ténèbres: 1.0 } },
  { id: "e_auto_aerien", name: "Automate aérien", icon: "🤖", hp: 35, dmg: 12, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 1.05, dodge: 0.10, mav: 1.05, xp: 0, gold: 0, er: { Feu: 1.0, Terre: 0.0, Foudre: 1.30, Eau: 1.0, Sacré: 1.0, Ténèbres: 1.0 } },
  { id: "e_auto_reparateur", name: "Automate réparateur", icon: "🤖", hp: 50, dmg: 8, at: "physical", str: 1.0, mag: 1.0, crit: 0.03, phv: 0.90, dodge: 0.03, mav: 0.90, rgHp: 0.15, xp: 0, gold: 0, er: { Feu: 1.0, Terre: 1.0, Foudre: 1.0, Eau: 1.0, Sacré: 1.0, Ténèbres: 1.0 } },
  { id: "e_auto_chromatique", name: "Automate chromatique", icon: "🤖", hp: 40, dmg: 14, at: "magical", str: 1.0, mag: 1.0, crit: 0.05, phv: 0.95, dodge: 0.05, mav: 0.95, xp: 0, gold: 0, er: { Feu: 0.10, Terre: 0.10, Foudre: 0.10, Eau: 0.10, Sacré: 0.10, Ténèbres: 0.10 } },
  { id: "e_auto_miroir", name: "Automate miroir", icon: "🤖", hp: 40, dmg: 12, at: "magical", str: 1.0, mag: 1.0, crit: 0.05, phv: 0.80, dodge: 0.08, mav: 0.80, xp: 0, gold: 0, er: { Feu: 1.0, Terre: 1.0, Foudre: 1.0, Eau: 1.0, Sacré: 0.80, Ténèbres: 0.80 } },
];

export var BSS = [
  { id: "b_loup_garou", name: "Loup-Garou", icon: "🐺", hp: 180, dmg: 18, at: "physical", str: 1.0, mag: 1.0, crit: 0.10, phv: 0.92, dodge: 0.08, mav: 1.04, xp: 30, gold: 25, boss: true, er: { Feu: 1.1, Terre: 1, Foudre: 1, Eau: 1, Sacré: 1.15, Ténèbres: 1 } },
  { id: "b_ours_noir", name: "Ours Noir", icon: "🐻", hp: 250, dmg: 20, at: "physical", str: 1.0, mag: 1.0, crit: 0.06, phv: 0.86, dodge: 0.02, mav: 1.02, xp: 40, gold: 35, boss: true, er: { Feu: 1.2, Terre: 1, Foudre: 1, Eau: 1, Sacré: 1, Ténèbres: 1 } },
  { id: "b_kraken", name: "Kraken", icon: "🦑", hp: 220, dmg: 18, at: "magical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.90, dodge: 0.04, mav: 0.88, xp: 45, gold: 40, boss: true, er: { Feu: 1, Terre: 1, Foudre: 1.25, Eau: 0, Sacré: 1, Ténèbres: 1 } },
  { id: "b_ver_sables", name: "Ver des sables", icon: "🪱", hp: 200, dmg: 22, at: "physical", str: 1.0, mag: 1.0, crit: 0.06, phv: 0.94, dodge: 0.18, mav: 1.0, xp: 50, gold: 45, boss: true, er: { Feu: 1, Terre: 0.7, Foudre: 1, Eau: 1.3, Sacré: 1, Ténèbres: 1 } },
  { id: "b_banshee", name: "Banshee", icon: "👻", hp: 180, dmg: 20, at: "magical", str: 1.0, mag: 1.0, crit: 0.06, phv: 0.96, dodge: 0.10, mav: 0.90, xp: 55, gold: 50, boss: true, er: { Feu: 0.9, Terre: 0.9, Foudre: 0.9, Eau: 0.9, Sacré: 1.4, Ténèbres: 0.85 } },
  { id: "b_pegre_mage", name: "Parrain Mage", icon: "🧙", hp: 150, dmg: 19, at: "magical", str: 1.0, mag: 1.0, crit: 0.06, phv: 1.02, dodge: 0.06, mav: 0.88, xp: 30, gold: 30, boss: true, er: { Feu: 1, Terre: 1, Foudre: 1, Eau: 1, Sacré: 1.15, Ténèbres: 0.85 } },
  { id: "b_pegre_tank", name: "Parrain Tank", icon: "🛡️", hp: 280, dmg: 12, at: "physical", str: 1.0, mag: 1.0, crit: 0.02, phv: 0.82, dodge: 0.01, mav: 0.94, xp: 30, gold: 30, boss: true, er: defER() },
  { id: "b_pegre_assassin", name: "Parrain Assassin", icon: "🥷", hp: 130, dmg: 23, at: "physical", str: 1.0, mag: 1.0, crit: 0.18, phv: 1.0, dodge: 0.14, mav: 1.02, xp: 30, gold: 30, boss: true, er: defER() },
  { id: "b_heritier", name: "Héritier pestiféré", icon: "👑", hp: 240, dmg: 19, at: "magical", str: 1.0, mag: 1.0, crit: 0.06, phv: 0.80, dodge: 0.10, mav: 0.88, xp: 65, gold: 55, boss: true, er: { Feu: 1, Terre: 1, Foudre: 1, Eau: 1, Sacré: 1.2, Ténèbres: 0.80 } },
  { id: "b_necromancien", name: "Nécromancien", icon: "💀", hp: 200, dmg: 18, at: "magical", str: 1.0, mag: 1.0, crit: 0.05, phv: 0.98, dodge: 0.04, mav: 0.86, xp: 70, gold: 60, boss: true, er: { Feu: 1, Terre: 1, Foudre: 1, Eau: 1, Sacré: 1.35, Ténèbres: 0 } },
  { id: "b_phobos", name: "Phobos", icon: "🔥", hp: 200, dmg: 20, at: "physical", str: 1.0, mag: 1.0, crit: 0.08, phv: 0.90, dodge: 0.06, mav: 0, xp: 50, gold: 45, boss: true, er: { Feu: 0.5, Terre: 0.5, Foudre: 0, Eau: 0, Sacré: 1, Ténèbres: 1 } },
  { id: "b_deimos", name: "Deimos", icon: "🌊", hp: 200, dmg: 20, at: "magical", str: 1.0, mag: 1.0, crit: 0.08, phv: 0, dodge: 0.06, mav: 0.90, xp: 50, gold: 45, boss: true, er: { Feu: 0, Terre: 0, Foudre: 0.5, Eau: 0.5, Sacré: 1, Ténèbres: 1 } },
  { id: "b_myhrra", name: "Myhrra", icon: "😈", hp: 350, dmg: 26, at: "physical", str: 1.0, mag: 1.0, crit: 0.12, phv: 0.86, dodge: 0.06, mav: 0.88, xp: 100, gold: 80, boss: true, er: { Feu: 0, Terre: 0.85, Foudre: 0.85, Eau: 1.15, Sacré: 1.2, Ténèbres: 0.6 } },
];
...
export var FRAGMENTS = [
  ...
  { id: "frag_zevor", name: "Fragment d'âme (Zevor)", heroId: "zevor", rarity: 2, icon: "🧩" },
...
export var BUP = [
  ...
  // === BOSS LABYRINTHE MÉCANIQUE ===
  { id: "b_mecanon_1", name: "Mécanon MK-I", icon: "🤖", hp: 120, dmg: 18, at: "physical", str: 1.0, mag: 1.0, crit: 0.04, phv: 0.90, dodge: 0.03, mav: 0.95, xp: 0, gold: 0, er: { Feu: 1.0, Terre: 1.0, Foudre: 1.0, Eau: 1.0, Sacré: 1.0, Ténèbres: 1.0 } },
  { id: "b_mecanon_2", name: "Mécanon MK-II", icon: "🤖", hp: 120, dmg: 18, at: "physical", str: 1.0, mag: 1.0, crit: 0.05, phv: 0.85, dodge: 0.04, mav: 0.90, xp: 0, gold: 0, er: { Feu: 0.80, Terre: 1.0, Foudre: 1.0, Eau: 0.80, Sacré: 1.0, Ténèbres: 1.0 } },
  { id: "b_mecanon_3", name: "Mécanon MK-III", icon: "🤖", hp: 120, dmg: 18, at: "physical", str: 1.0, mag: 1.0, crit: 0.05, phv: 0.82, dodge: 0.04, mav: 0.87, rgHp: 0.01, xp: 0, gold: 0, er: { Feu: 0.70, Terre: 0.90, Foudre: 1.0, Eau: 0.70, Sacré: 1.0, Ténèbres: 0.90 } },
  { id: "b_mecanon_4", name: "Mécanon MK-IV", icon: "🤖", hp: 120, dmg: 18, at: "physical", str: 1.0, mag: 1.0, crit: 0.06, phv: 0.78, dodge: 0.05, mav: 0.84, rgHp: 0.01, xp: 0, gold: 0, er: { Feu: 0.60, Terre: 0.80, Foudre: 1.0, Eau: 0.60, Sacré: 0.90, Ténèbres: 0.80 } },
  { id: "b_mecanon_5", name: "Mécanon MK-V", icon: "🤖", hp: 120, dmg: 18, at: "physical", str: 1.0, mag: 1.0, crit: 0.06, phv: 0.75, dodge: 0.05, mav: 0.80, rgHp: 0.02, xp: 0, gold: 0, er: { Feu: 0.70, Terre: 0.70, Foudre: 1.0, Eau: 0.70, Sacré: 0.70, Ténèbres: 0.70 } },
  { id: "b_mecanon_6", name: "Mécanon MK-VI", icon: "🤖", hp: 120, dmg: 18, at: "physical", str: 1.0, mag: 1.0, crit: 0.07, phv: 0.72, dodge: 0.06, mav: 0.77, rgHp: 0.02, xp: 0, gold: 0, er: { Feu: 0.60, Terre: 0.60, Foudre: 1.0, Eau: 0.60, Sacré: 0.60, Ténèbres: 0.60 } },
  { id: "b_mecanon_7", name: "Mécanon MK-VII", icon: "🤖", hp: 120, dmg: 18, at: "physical", str: 1.0, mag: 1.0, crit: 0.07, phv: 0.68, dodge: 0.06, mav: 0.74, rgHp: 0.03, xp: 0, gold: 0, er: { Feu: 0.50, Terre: 0.50, Foudre: 1.0, Eau: 0.50, Sacré: 0.50, Ténèbres: 0.50 } },
  { id: "b_mecanon_8", name: "Mécanon MK-VIII", icon: "🤖", hp: 120, dmg: 18, at: "physical", str: 1.0, mag: 1.0, crit: 0.08, phv: 0.65, dodge: 0.07, mav: 0.70, rgHp: 0.03, xp: 0, gold: 0, er: { Feu: 0.40, Terre: 0.40, Foudre: 1.0, Eau: 0.40, Sacré: 0.40, Ténèbres: 0.40 } },
