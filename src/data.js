...
export var HEROES = [
  { id: "enzi", name: "Enzi", title: "Aventurier solitaire", rarity: 1, icon: "🗡️", color: "#7f8c8d", wt: "physical",
    ...
    lv1: { hp: 31, rel: 7, str: 1.0, mag: 1, crit: 0.03, phv: 1.0, mav: 1.04, dodge: 0.05 },
    lv100: { hp: 2000, rel: 7, str: 1.19, mag: 1, crit: 0.06, phv: 0.91, mav: 0.97, dodge: 0.05 },
  ...
  { id: "kiara", name: "Kiara", title: "Nomade du désert", rarity: 1, icon: "⚔️", color: "#d4a017", wt: "physical",
    ...
    lv1: { hp: 35, rel: 8, str: 1.01, mag: 1, crit: 0.03, phv: 0.99, mav: 1.01, dodge: 0.04 },
    lv100: { hp: 2100, rel: 8, str: 1.22, mag: 1, crit: 0.05, phv: 0.9, mav: 0.95, dodge: 0.04 },
  ...
  { id: "marken", name: "Marken", title: "Preux chevalier", rarity: 1, icon: "🛡️", color: "#2c3e50", wt: "physical",
    ...
    lv1: { hp: 37, rel: 8, str: 1.02, mag: 1, crit: 0.02, phv: 0.98, mav: 1.08, dodge: 0.03 },
    lv100: { hp: 2250, rel: 8, str: 1.25, mag: 1, crit: 0.04, phv: 0.87, mav: 1.02, dodge: 0.03 },
  ...
  { id: "mira", name: "Mira", title: "Apprentie sorcière", rarity: 1, icon: "🔮", color: "#e67e22", wt: "magical",
    ...
    lv1: { hp: 24, rel: 7, str: 1, mag: 1.01, crit: 0.02, phv: 1.1, mav: 0.99, dodge: 0.04 },
    lv100: { hp: 1300, rel: 7, str: 1, mag: 1.22, crit: 0.05, phv: 1.02, mav: 0.92, dodge: 0.04 },
  ...
  { id: "constello", name: "Constello", title: "Saltimbanque survolté", rarity: 2, icon: "🎭", color: "#e84393", wt: "physical",
    ...
    lv1: { hp: 32, rel: 7, str: 1.06, mag: 1, crit: 0.04, phv: 0.96, mav: 1.10, dodge: 0.05 },
    lv100: { hp: 2000, rel: 7, str: 1.30, mag: 1, crit: 0.07, phv: 0.85, mav: 1.04, dodge: 0.05 },
  ...
  { id: "sahad", name: "Sahad", title: "Aquamage", rarity: 2, icon: "💧", color: "#3498db", wt: "magical",
    ...
    lv1: { hp: 27, rel: 8, str: 1, mag: 1.02, crit: 0.03, phv: 1.04, mav: 0.97, dodge: 0.04 },
    lv100: { hp: 1450, rel: 8, str: 1, mag: 1.25, crit: 0.05, phv: 0.97, mav: 0.89, dodge: 0.04 },
  ...
  { id: "syrio", name: "Syrio", title: "Défenseur inébranlable", rarity: 2, icon: "🏰", color: "#c0392b", wt: "physical",
    ...
    lv1: { hp: 46, rel: 8, str: 1.0, mag: 1, crit: 0.02, phv: 0.91, mav: 0.99, dodge: 0.03 },
    lv100: { hp: 2900, rel: 8, str: 1.16, mag: 1, crit: 0.04, phv: 0.82, mav: 0.91, dodge: 0.03 },
  ...
  { id: "cerys", name: "Cerys", title: "Sombre inquisitrice", rarity: 3, icon: "🌑", color: "#6c3483", wt: "magical",
    ...
    lv1: { hp: 24, rel: 7, str: 1, mag: 1.05, crit: 0.03, phv: 1.04, mav: 1.0, dodge: 0.04 },
    lv100: { hp: 1300, rel: 7, str: 1, mag: 1.35, crit: 0.05, phv: 0.97, mav: 0.92, dodge: 0.04 },
  ...
  { id: "keros", name: "Keros", title: "Saurien mystérieux", rarity: 3, icon: "🦎", color: "#27ae60", wt: "physical",
    ...
    lv1: { hp: 32, rel: 8, str: 1.01, mag: 1, crit: 0.03, phv: 0.99, mav: 0.99, dodge: 0.04, rgHp: 0.01 },
    lv100: { hp: 2100, rel: 8, str: 1.22, mag: 1, crit: 0.04, phv: 0.91, mav: 0.91, dodge: 0.04, rgHp: 0.03 },
  ...
  { id: "orion", name: "Orion", title: "Félin malicieux", rarity: 4, icon: "🐱", color: "#f39c12", wt: "magical",
    ...
    lv1: { hp: 23, rel: 7, str: 1, mag: 1.04, crit: 0.04, phv: 1.12, mav: 0.97, dodge: 0.06 },
    lv100: { hp: 1200, rel: 7, str: 1, mag: 1.30, crit: 0.05, phv: 1.04, mav: 0.87, dodge: 0.06 },
